...
for i, usuario in enumerate(usuarios):
    ...
    text = f"""ID producto: {usuario['id']} nombre del producto: {usuario['nombre']} descripcion del producto: {usuario['descripcion']}"""
...
def endpoint_buscar(query: str = Query(..., description="Texto a buscar"), threshold: float = 0.45):
    print("Aùn no hubo Invalid HTTP request received.")
    try:
